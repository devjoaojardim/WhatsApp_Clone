...
//Primeiro Extends a classe principal
// Segunddo Cria uma classe dentro da principal com MyViewHolder
// Terceiro Cria os metodos

public class ContatosAdapter extends RecyclerView.Adapter<ContatosAdapter.MyViewHolder> {
    private List<Usuario> contatos;
    private Context context;
    public ContatosAdapter(List<Usuario> listContato, Context c) {
        this.contatos = listContato;
        this.context = c;
